...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const projectsData = [
    ...
    { title: "INSIGHT-AI — Multilingual AI Health Triage Chatbot", category: "AI / NLP / Healthcare", desc: "Built a multilingual AI health triage chatbot using RAG. Embedded 40+ MB medical documents into a FAISS vector DB for contextual & safe medical answers. Designed responsive UI with voice and multilingual support.", stack: ["Python", "LangChain", "FAISS", "Streamlit", "Gemini AI", "RAG"], image: "https://placehold.co/400x200/ECE9E2/5B7F67?text=INSIGHT-AI+Chatbot", link: "https://github.com/SudheerKonduboina/INSIGHT-AI" },
    { title: "DevOps – CI/CD Automation Project", category: "DevOps / Cloud Automation", desc: "Developed a Python Flask web app, containerized with Docker, and automated end-to-end CI/CD using GitHub Actions for deployment on Render.", stack: ["Python", "Flask", "Docker", "GitHub Actions", "CI/CD", "Render"], image: "https://placehold.co/400x200/ECE9E2/5B7F67?text=Flask+CI/CD+Demo", link: "https://github.com/SudheerKonduboina/devops_demo" },
    { title: "DevOps – CI/CD + Kubernetes Project", category: "DevOps / Kubernetes", desc: "Designed and deployed a Node.js app with automated CI/CD. Wrote Dockerfile and Kubernetes manifests (YAML). Gained practical K8s + Docker integration experience.", stack: ["Node.js", "Docker", "Kubernetes", "YAML", "GitHub Actions"], image: "https://placehold.co/400x200/ECE9E2/5B7F67?text=K8s+CI/CD+Pipeline", link: "https://github.com/SudheerKonduboina/devops-demo-assignment/tree/main/.github" },
    { title: "Voice Sentiment Assistant — Speech Emotion Recognition", category: "AI / Speech Processing", desc: "Built an ML model that detects emotions from voice input. Extracted MFCC & Chroma features and trained a CNN + SVM hybrid model. Created an interactive dashboard for monitoring.", stack: ["Python", "TensorFlow", "Librosa", "Scikit-Learn", "SpeechRecognition"], image: "https://placehold.co/400x200/ECE9E2/5B7F67?text=Voice+Sentiment+AI", link: "https://github.com/SudheerKonduboina/ai-voice-sentimentanalysis-bot" },
    { title: "AI Text Generator — Transformer-Based Text Generation", category: "NLP / Deep Learning", desc: "Developed a transformer-based text generation model with sentiment control. Added chat history and downloadable responses in a Streamlit front-end.", stack: ["Python", "TensorFlow", "Hugging Face", "Streamlit", "Keras"], image: "https://placehold.co/400x200/ECE9E2/5B7F67?text=AI+Text+Generator", link: "https://github.com/SudheerKonduboina/ai-text-generator-sentiment" }
  ];
